...
def test_smoke_update_gemini_send_message_cycle(tmp_path: Path) -> None:
    ...
    def handler(request: httpx.Request) -> httpx.Response:
            ...
            return httpx.Response(
                ...
                json={
                    ...
                    "result": [
                        {
                            "update_id": 100,
                            "message": {"chat": {"id": 42}, "text": "💭 Мне тяжело"},
                        }
                    ],
                },
            )
        ...
        if host == "generativelanguage.googleapis.com":
            ...
            return httpx.Response(
                ...
                json={
                    "candidates": [
                        {"content": {"parts": [{"text": "Поддерживающий ответ"}]}}
                    ]
                },
            )
    ...
    assert calls["sent_text"] == "Поддерживающий ответ"
    assert storage.get_history(42) == ""


def test_smoke_gemini_error_fallback_message_and_continue(tmp_path: Path) -> None:
    calls: dict[str, object] = {
        "gemini": 0,
        "send_message": 0,
        "sent_text": "",
