...
def test_normalize_ui_text_keeps_static_template_with_inner_quotes() -> None:
    text = "Попробуй спросить не «чего я хочу?», а «что мне сейчас может быть чуть полезно?» При апатии чувство желания часто отключено, но потребности всё равно остаются."
    assert (
        normalize_ui_text(text)
